...
import (
	...
	"github.com/compassorg/mongodb-service-broker/services"
...
func (i *InstancesController) Instance() {
	...
	if result, err := services.MongoDBServiceBrokerInstance().ServiceInstance(instanceId); err == nil {
...
func (i *InstancesController) Provision() {
	...
	if result, err := services.MongoDBServiceBrokerInstance().Provision(instanceId, &req); err == nil {
...
func (i *InstancesController) DeProvision() {
	...
	if result, err := services.MongoDBServiceBrokerInstance().DeProvision(instanceId); err == nil {
		writeResponse(i, http.StatusOK, result)
	} else {
		writeErrResponse(i, http.StatusBadRequest, err)
	}
...
func (i *InstancesController) Binding() {
	...
	if result, err := services.MongoDBServiceBrokerInstance().Binding(instanceId, bindingId, &req); err == nil {
		writeResponse(i, http.StatusOK, result)
	} else {
		writeErrResponse(i, http.StatusBadRequest, err)
	}
...
func (i *InstancesController) UnBinding() {
	...
	if err := services.MongoDBServiceBrokerInstance().UnBinding(instanceId, bindingId); err == nil {
...
func (i *InstancesController) ServiceInstanceLastOperation() {
	...
	if result, err := services.MongoDBServiceBrokerInstance().ServiceInstanceLastOperation(instanceId, serviceId, planId, operation); err == nil {
		writeResponse(i, http.StatusOK, result)
	} else {
		writeErrResponse(i, http.StatusBadRequest, err)
	}
