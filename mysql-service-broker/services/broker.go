...
var (
	mysqlServiceBroker *MySQLServiceBroker
	lastOperationMap    map[string]int64
)

type MySQLServiceBroker struct {
}

func MySQLServiceBrokerInstance() *MySQLServiceBroker {
	if mysqlServiceBroker == nil {
		mysqlServiceBroker = &MySQLServiceBroker{}
	}
	return mysqlServiceBroker
}

func (o *MySQLServiceBroker) Catalog() *brokerapi.Catalog {
	return readBrokerSettings()
}

func (o *MySQLServiceBroker) ServiceInstance(id string) (userProvidedServiceInstance, error) {
...
func (o *MySQLServiceBroker) Provision(id string, req *brokerapi.CreateServiceInstanceRequest) (*brokerapi.CreateServiceInstanceResponse, error) {
	...
	if !ok {
		...
		DashboardURL = generateMySQLUri(*userName, *userPassword, connectURI.(string), *databaseName)
...
func (o *MySQLServiceBroker) DeProvision(id string) (*brokerapi.DeleteServiceInstanceResponse, error) {
	//o.rwMutex.Lock()
...
func (o *MySQLServiceBroker) Binding(instanceID, bindingID string, req *brokerapi.BindingRequest) (*brokerapi.CreateServiceBindingResponse, error) {
	//o.rwMutex.RLock()
...
func (o *MySQLServiceBroker) UnBinding(instanceId, bindingId string) error {
	// Since we don't persist the binding, there's nothing to do here.
	return nil
}

func (o *MySQLServiceBroker) ServiceInstanceLastOperation(instanceID, serviceID, planID, operation string) (*brokerapi.LastOperationResponse, error) {
