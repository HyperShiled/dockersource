...
func (i *InstancesController) Instance() {
	...
	if result, err := services.DB2ServiceBrokerInstance().ServiceInstance(instanceId); err == nil {
...
func (i *InstancesController) Provision() {
	...
	if result, err := services.DB2ServiceBrokerInstance().Provision(instanceId, &req); err == nil {
...
func (i *InstancesController) DeProvision() {
	...
	if result, err := services.DB2ServiceBrokerInstance().DeProvision(instanceId); err == nil {
		writeResponse(i, http.StatusOK, result)
	} else {
		writeErrResponse(i, http.StatusBadRequest, err)
	}
...
func (i *InstancesController) Binding() {
	...
	if result, err := services.DB2ServiceBrokerInstance().Binding(instanceId, bindingId, &req); err == nil {
		writeResponse(i, http.StatusOK, result)
	} else {
		writeErrResponse(i, http.StatusBadRequest, err)
	}
...
func (i *InstancesController) UnBinding() {
	...
	if err := services.DB2ServiceBrokerInstance().UnBinding(instanceId, bindingId); err == nil {
...
func (i *InstancesController) ServiceInstanceLastOperation() {
	...
	if result, err := services.DB2ServiceBrokerInstance().ServiceInstanceLastOperation(instanceId, serviceId, planId, operation); err == nil {
		writeResponse(i, http.StatusOK, result)
	} else {
		writeErrResponse(i, http.StatusBadRequest, err)
	}
