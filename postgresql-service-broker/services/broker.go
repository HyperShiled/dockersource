...
var (
	postgresqlServiceBroker *PostgreSQLServiceBroker
	lastOperationMap    map[string]int64
)

type PostgreSQLServiceBroker struct {
}

func PostgreSQLServiceBrokerInstance() *PostgreSQLServiceBroker {
	if postgresqlServiceBroker == nil {
		postgresqlServiceBroker = &PostgreSQLServiceBroker{}
	}
	return postgresqlServiceBroker
}

func (o *PostgreSQLServiceBroker) Catalog() *brokerapi.Catalog {
	return readBrokerSettings()
}

func (o *PostgreSQLServiceBroker) ServiceInstance(id string) (userProvidedServiceInstance, error) {
...
func (o *PostgreSQLServiceBroker) Provision(id string, req *brokerapi.CreateServiceInstanceRequest) (*brokerapi.CreateServiceInstanceResponse, error) {
	...
	if !ok {
		...
		databaseName, userName, userPassword, err := createDatabaseAndUser(connectURI.(string), planValue)
		...
		DashboardURL = generatePostgreSQLUri(*userName, *userPassword, connectURI.(string), *databaseName)
...
func (o *PostgreSQLServiceBroker) DeProvision(id string) (*brokerapi.DeleteServiceInstanceResponse, error) {
	//o.rwMutex.Lock()
...
func (o *PostgreSQLServiceBroker) Binding(instanceID, bindingID string, req *brokerapi.BindingRequest) (*brokerapi.CreateServiceBindingResponse, error) {
	//o.rwMutex.RLock()
...
func (o *PostgreSQLServiceBroker) UnBinding(instanceId, bindingId string) error {
	// Since we don't persist the binding, there's nothing to do here.
	return nil
}


func (o *PostgreSQLServiceBroker) ServiceInstanceLastOperation(instanceID, serviceID, planID, operation string) (*brokerapi.LastOperationResponse, error) {
