...
JAVA_OPTIONS="${JAVA_OPTIONS} -javaagent:/u01/oracle/user_projects/domains/base_domain/bin/jmx_prometheus_javaagent-0.10.jar=9000:/u01/oracle/user_projects/domains/base_domain/bin/config.yaml"
